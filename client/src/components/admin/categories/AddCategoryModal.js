...
const AddCategoryModal = (props) => {
  ...
  const submitForm = async (e) => {
    ...
    if (!fData.cImage) {
      ...
      return setFdata({ ...fData, error: "Please upload a District Image" });
    }
        ...
        <div className="relative bg-white w-12/12 md:w-3/6 shadow-lg flex flex-col items-center space-y-4  overflow-y-auto px-4 py-4 md:px-8">
          ...
          <form className="w-full" onSubmit={(e) => submitForm(e)}>
            ...
            <div className="flex flex-col space-y-1 w-full">
              <label htmlFor="description">District Description</label>
              <textarea
                onChange={(e) =>
                  setFdata({
                    ...fData,
            ...
            <div className="flex flex-col space-y-1 w-full">
              <label htmlFor="name">District Image</label>
              <input
                accept=".jpg, .jpeg, .png"
                onChange={(e) => {
                  setFdata({
            ...
            <div className="flex flex-col space-y-1 w-full">
              <label htmlFor="status">District Status</label>
              <select
                name="status"
                onChange={(e) =>
                  setFdata({
